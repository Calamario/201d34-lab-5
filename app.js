...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  var firstSum = sum(a, b).shift();
  var finalSum = sum(firstSum, c).shift();
  var firstPruduct = multiply(a, b).shift();
  var finalProduct = multiply(firstPruduct, c).shift();
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var b = sumArr[1];
  var c = sumArr[2];
  var sumNumber = sumAndMultiply(a,b,c)[0];
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for(var i = 0; i < multArr.length; i ++) {
    numCounter = multiply(multArr[i], numCounter)[0];
  }
  return [numCounter, 'The numbers ' + multArr.join(',') + ' have a product of ' + numCounter + '.'];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(var i = 0; i < dynamicArray.length; i ++) {
    numCounter = multiply(dynamicArray[i], numCounter)[0];
  }
  return [numCounter, 'The numbers ' + dynamicArray.join(',') + ' have a product of ' + numCounter + '.'];
}
